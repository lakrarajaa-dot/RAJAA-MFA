...
const USERS = [
  {
    ...
    passwordHash: bcrypt.hashSync('VotreMotDePasse', 10),
    totpSecret: speakeasy.generateSecret({ name: 'MFA App (votre@email.com)' }),
    phone: '+33600000000',
    name: 'Prénom'
  }
];
...
> ⚠️ **En production**, remplacez ce tableau par des appels à une base de données (voir section [Passage en production](#-passage-en-production)).
